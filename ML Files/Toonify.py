...
# ... (The caart(), update_c(), and K_histogram() functions)
def update_c(C,hist):
    while True:
...
def cartoonize_video(camera_index):
...
if __name__ == "__main__":
    # Replace '0' with the correct camera index for your external webcam
    camera_index = 1  # Replace with the correct index
    cartoonize_video(camera_index)
...
output=caart(cv2.imread("m.jpg"))
cv2.imwrite("cartoon24.jpg", output)
